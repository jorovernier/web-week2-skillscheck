...
var me = {
	...
	state: 'Arizona',
	age: 19,
	greeter: function hello(firstName, state,){
...
var doubled = myNumbers.map(function(number){
	return number * 2;
});
...
var filtered = myNumbers.filter(function(number){
	if(number > 100){
		return number;
	}
});
...
var total = myNumbers.reduce(function(total, number){
	return total += number;
})
...
var myNumbersIndex = [];
myNumbers.forEach(function(number, index, array) {
...
var totallyAwesome = people.reduce(function(total, element){
