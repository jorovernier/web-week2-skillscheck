...
var faveColors = ['red', 'blue', 'purple']
...
var me = {
    firstName: 'Joely',
    superHeroName: 'Joely Guacamole',
    homeTown: 'Ventura',
    superPowers: ['gaming', 'cooking', 'coding'],
    superPowerXP: function superPowerXP(){return Math.floor(Math.random() * 100) + 1},
    profileImage: function profileImage(){return `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`}
}
...
var regularName = 'Joely';
var superName = 'Joely Guacamole';
var homeTown = 'Ventura';
